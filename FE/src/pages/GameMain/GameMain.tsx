  ...
  return (
    <>
      ...
      {isFullscreen ? (
        ...
        <div className="w-screen  bg-black select-none flex items-center justify-center overflow-hidden">
          <div
            className="w-full  bg-cover bg-center bg-no-repeat fixed inset-0"
            style={{ backgroundImage: `url(${bgImg})` }}
          >
            <div className="absolute inset-0 bg-gradient-to-r from-black to-[#11223349] opacity-100" />
          </div>
