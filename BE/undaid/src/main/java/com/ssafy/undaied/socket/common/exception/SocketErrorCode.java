...
public enum SocketErrorCode {
    ...
    GAME_ALREADY_INITIALIZING(4013, "게임 초기화가 이미 진행 중입니다."),

    NOT_ROOM_HOST(4014, "방장만 게임을 시작할 수 있습니다."),
    INVALID_PLAYER_COUNT(4015, "참가자 수가 올바르지 않습니다."),

    SOCKET_DISCONNECTION_ERROR(4016, "소켓 연결 종료 중 오류가 발생했습니다."),
    NOT_HOST(4017,"방장만 게임을 진행할 수 있습니다."),
    GAME_NOT_FOUND(4018, "게임을 찾을 수 없습니다."),

    GAME_NOT_ENDED(4019, "게임이 정상적으로 끝나지 않았습니다."),

    PLAYER_NOT_FOUND(4020, "플레이어를 찾을 수 없습니다.")
