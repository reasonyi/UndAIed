package com.ssafy.undaid.domain.game.service;

import com.ssafy.undaid.domain.game.dto.response.GameDetailResponseDto;
import com.ssafy.undaid.domain.game.dto.response.GameRecordResponseDTO;
import com.ssafy.undaid.domain.game.entity.GameRecords;
import com.ssafy.undaid.domain.game.entity.Games;
import com.ssafy.undaid.domain.game.entity.respository.GameRecordsRepository;
import com.ssafy.undaid.domain.game.entity.respository.GamesRepository;
...
import static com.ssafy.undaid.global.common.exception.ErrorCode.GAME_NOT_FOUND;
